...
//
// Description:
// This header file declares functions used to configure the
// Phase-Locked Loop (PLL) to set the system clock frequency.
// A stable system clock is required for accurate SysTick timing
...
#define SYSDIV2 10
// bus frequency is 400MHz/(SYSDIV2+1) = 400MHz/(10+1) = 40 MHz
